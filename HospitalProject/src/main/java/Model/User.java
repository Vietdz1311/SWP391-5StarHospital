...
public class User {
    ...
    public User(int id, int roleId, String fullName, String idCardNumber, String phoneNumber,
                LocalDate birthDate, String gender, String address, String username,
                String profilePicture, String email, String password, String status,
